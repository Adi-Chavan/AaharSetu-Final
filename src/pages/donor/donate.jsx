...
//       fetch(`https://nominatim.openstreetmap.org/search?format=json&q=${encodeURIComponent(formData.pickupAddress)}`)
//         .then(res => res.json())
//         .then(data => {
//           if (data.length > 0) {
//             setFormData(prev => ({
...
//                 <p className="text-sm mt-2">Selected Location: {formData.latitude}, {formData.longitude}</p>
//               )}
//             </div>
//             <div>
