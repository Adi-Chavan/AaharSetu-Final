...
// import { MapPin, Clock, Utensils, Users, Navigation, Phone, Search } from 'lucide-react';
...
//                 <Button 
//                   onClick={() => setSelectedDonation(recommendation)}
//                   className="w-full"
//                 >
//                   View Details
//                 </Button>
...
//               >
//                 <div className="flex justify-between items-start mb-4">
//                   <h2 className="text-xl font-semibold">{recommendation.title.substring(0, 30)}</h2>
//                   <span className={`px-3 py-1 rounded-full text-sm ${getFoodTypeColor(recommendation.foodType)}`}>
//                     {recommendation.foodType.toUpperCase()}
//                   </span>
//                 </div>
